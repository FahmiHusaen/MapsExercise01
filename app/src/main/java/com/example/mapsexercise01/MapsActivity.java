package com.example.mapsexercise01;
...
import com.example.mapsexercise01.databinding.ActivityMapsBinding;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng rumahSaya = new LatLng(-7.642073, 110.367415);
        mMap.addMarker(new MarkerOptions().position(rumahSaya).title("Rumah Saya"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(rumahSaya));

        onMapLongClicked(googleMap);
        onPoinClicked(googleMap);
    }
    ...
    public void onPoinClicked(final GoogleMap mMap){
